...
class RoomState$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.syncTargetSeconds !== 0)
            writer.tag(21, runtime_1.WireType.Bit64).double(message.syncTargetSeconds);
        /* uint64 sync_launch_at_ms = 22; */
        if (message.syncLaunchAtMs !== 0n)
            writer.tag(22, runtime_1.WireType.Varint).uint64(message.syncLaunchAtMs);
        /* string sync_mode = 23; */
        if (message.syncMode !== "")
            writer.tag(23, runtime_1.WireType.LengthDelimited).string(message.syncMode);
        /* repeated string sync_ready_user_ids = 24; */
        for (let i = 0; i < message.syncReadyUserIds.length; i++)
            writer.tag(24, runtime_1.WireType.LengthDelimited).string(message.syncReadyUserIds[i]);
        /* string media_source_type = 25; */
        if (message.mediaSourceType !== "")
            writer.tag(25, runtime_1.WireType.LengthDelimited).string(message.mediaSourceType);
        /* string resolved_media_url = 26; */
        if (message.resolvedMediaUrl !== "")
            writer.tag(26, runtime_1.WireType.LengthDelimited).string(message.resolvedMediaUrl);
        /* string media_pipeline_status = 27; */
        if (message.mediaPipelineStatus !== "")
            writer.tag(27, runtime_1.WireType.LengthDelimited).string(message.mediaPipelineStatus);
        /* string media_pipeline_message = 28; */
        if (message.mediaPipelineMessage !== "")
            writer.tag(28, runtime_1.WireType.LengthDelimited).string(message.mediaPipelineMessage);
...
// @generated message type with reflection information, may provide speed optimized methods
class ReportSyncStatusRequest$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.currentTimeSeconds !== 0)
            writer.tag(2, runtime_1.WireType.Bit64).double(message.currentTimeSeconds);
        /* bool ready = 3; */
        if (message.ready !== false)
            writer.tag(3, runtime_1.WireType.Varint).bool(message.ready);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.ReportSyncStatusRequest = new ReportSyncStatusRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class HostStartSyncRequest$Type extends runtime_4.MessageType {
    constructor() {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* string mode = 2; */
        if (message.mode !== "")
            writer.tag(2, runtime_1.WireType.LengthDelimited).string(message.mode);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? runtime_2.UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
 ...
 */
exports.HostStartSyncRequest = new HostStartSyncRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class HostLaunchSyncRequest$Type extends runtime_4.MessageType {
    constructor() {
 ...
 */
exports.HostLaunchSyncRequest = new HostLaunchSyncRequest$Type();
