...
export declare class CineLinkServiceClient extends CineLinkServiceClient_base implements RootClientService {
    ...
    reportSyncStatus(request: ReportSyncStatusRequest): Promise<MutationResponse>;
    hostStartSync(request: HostStartSyncRequest): Promise<MutationResponse>;
    hostLaunchSync(request: HostLaunchSyncRequest): Promise<MutationResponse>;
    private __register;
}
